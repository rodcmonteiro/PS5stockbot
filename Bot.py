...
websitesDict={
    'amazonDE':'http://www.amazon.de/-/en/dp/B08H93ZRK9/?th=1',
    'amazonUK':'https://www.amazon.co.uk/-/dp/B08H95Y452/?th=1'
}
...
amazonDEurl = websitesDict['amazonDE']
amazonDEpage = requests.get(amazonDEurl, headers=headers)
...
if title_elem == 'Sony PlayStation 5' and availability_elem != 'Currently unavailable.':
	pushbullet_message('PS5 in AmazonDE!', amazonDEurl)
